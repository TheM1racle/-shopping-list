...
abstract class AppLocalizations {
  ...
  /// No description provided for @stopShopping.
  ///
  /// In en, this message translates to:
  /// **'Stop shopping'**
  String get stopShopping;
  ...
  /// No description provided for @tapToMarkBought.
  ///
  /// In en, this message translates to:
  /// **'Tap notification to mark as bought'**
  String get tapToMarkBought;

  /// No description provided for @noUnpurchasedItems.
  ///
  /// In en, this message translates to:
  /// **'No unpurchased items left'**
  String get noUnpurchasedItems;
